    ...
    <>
      <div className="container">
        ...
        <div id="calculator">
          ...
          <button id="clear" onClick={() => buttonPress("clear")}>
            Clear
          </button>
          <button id="percentage" onClick={() => buttonPress("percentage")}>
            %
          </button>
          <button id="divide" onClick={() => buttonPress("/")}>
            /
          </button>
          <div id="buttons">
          ...
          <button id="multiply" onClick={() => buttonPress("*")}>
            *
          </button>

          <button id="subtract" onClick={() => buttonPress("-")}>
            -
          </button>
          ...
          <button id="decimal" onClick={() => buttonPress(".")}>
            .
          </button>
          <button id="equals" onClick={() => buttonPress("=")}>
            =
          </button>
        </div>
      </div>
